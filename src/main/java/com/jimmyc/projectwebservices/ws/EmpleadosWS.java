 ...
 * 
 */
package com.jimmyc.projectwebservices.ws;
...
import com.jimmyc.projectwebservices.service.EmpleadoService;
...
public class EmpleadosWS {
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response guardarEmpleadoEmpleado(Empleado empleado) {
		if(empleado == null) {
